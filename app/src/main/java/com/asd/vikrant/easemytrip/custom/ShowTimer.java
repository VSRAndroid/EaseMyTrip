package com.asd.vikrant.easemytrip.custom;
...
public class ShowTimer {
    ...
    public void StopTimer(TextView timeCountTextView) {
          ...
          timeCountTextView.setText("Ride Time: 00:00:00");
    ...
    private Runnable updateTimerThread = new Runnable()
       {
        public void run()
        {
                ...
                String timer = "Ride Time: "  + String.format("%02d", hours) + ":" + String.format("%02d", mins) + ":" + String.format("%02d", secs);
